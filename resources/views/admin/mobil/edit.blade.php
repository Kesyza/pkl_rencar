                ...
                <div class="card-body">
                   <form action="{{route('mobil.update',$mobil->id)}}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="merek_mobil" value="{{$mobil->merek_mobil}}" class="form-control @error('merek_mobil') is-invalid @enderror">
                             @error('merek_mobil')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="harga_mobil" value="{{$mobil->harga_mobil}}" class="form-control @error('harga_mobil') is-invalid @enderror">
                             @error('harga_mobil')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
